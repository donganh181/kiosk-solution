...
namespace kiosk_solution.Business.Services
{
    public interface IPoicategoryService
    {
        ...
        public Task<PoicategoryViewModel> UpdateName(PoiCategoryNameUpdateViewModel model);
        public Task<PoicategoryViewModel> UpdateLogo(PoiCategoryLogoUpdateViewModel model);
