...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AppCategory>(entity =>
            {
                ...
                entity.HasIndex(e => e.Name, "UQ__AppCateg__737584F6A694AA77")
                    .IsUnique();
            ...
            modelBuilder.Entity<ApplicationMarket>(entity =>
            {
                ...
                entity.HasIndex(e => e.Name, "UQ__Applicat__737584F6BAAFA0B4")
                    .IsUnique();
            ...
            modelBuilder.Entity<Party>(entity =>
            {
                ...
                entity.HasIndex(e => e.PhoneNumber, "UQ__Party__85FB4E3805325095")
                    .IsUnique();

                entity.HasIndex(e => e.Email, "UQ__Party__A9D10534E6B58337")
                    .IsUnique();
            ...
            modelBuilder.Entity<PartyNotification>(entity =>
            {
                ...
                entity.HasOne(d => d.Notification)
                    ...
                    .HasConstraintName("FK__PartyNoti__Notif__10566F31");

                entity.HasOne(d => d.Party)
                    .WithMany(p => p.PartyNotifications)
                    .HasForeignKey(d => d.PartyId)
                    .HasConstraintName("FK__PartyNoti__Party__0F624AF8");
            });
            ...
            modelBuilder.Entity<PartyServiceApplication>(entity =>
            {
                ...
                entity.HasOne(d => d.Party)
                    ...
                    .HasForeignKey(d => d.PartyId)
                    .HasConstraintName("FK__PartyServ__Party__74AE54BC");

                entity.HasOne(d => d.ServiceApplication)
                    .WithMany(p => p.PartyServiceApplications)
                    .HasForeignKey(d => d.ServiceApplicationId)
                    .HasConstraintName("FK__PartyServ__Servi__75A278F5");
            });
            ...
            modelBuilder.Entity<Poi>(entity =>
            {
                ...
                entity.HasOne(d => d.Creator)
                    .WithMany(p => p.Pois)
                    .HasForeignKey(d => d.CreatorId)
                    .HasConstraintName("FK__POI__Type__70DDC3D8");
            });
            ...
            modelBuilder.Entity<ScheduleTemplate>(entity =>
            {
                ...
                entity.HasOne(d => d.Schedule)
                    ...
                    .HasForeignKey(d => d.ScheduleId)
                    .HasConstraintName("FK__ScheduleT__Sched__797309D9");

                entity.HasOne(d => d.Template)
                    .WithMany(p => p.ScheduleTemplates)
                    .HasForeignKey(d => d.TemplateId)
                    .HasConstraintName("FK__ScheduleT__Templ__7A672E12");
            });
            ...
            modelBuilder.Entity<ServiceApplication>(entity =>
            {
                ...
                entity.HasIndex(e => e.Name, "UQ__ServiceA__737584F6F2414FFA")
                    .IsUnique();
            ...
            modelBuilder.Entity<ServiceOrder>(entity =>
            {
                ...
                entity.HasOne(d => d.Kiosk)
                    ...
                    .HasForeignKey(d => d.KioskId)
                    .HasConstraintName("FK__ServiceOr__Kiosk__02FC7413");

                entity.HasOne(d => d.Party)
                    .WithMany(p => p.ServiceOrders)
                    .HasForeignKey(d => d.PartyId)
                    .HasConstraintName("FK__ServiceOr__Party__02084FDA");

                entity.HasOne(d => d.ServiceApplication)
                    .WithMany(p => p.ServiceOrders)
                    .HasForeignKey(d => d.ServiceApplicationId)
                    .HasConstraintName("FK__ServiceOr__Servi__01142BA1");
            });
